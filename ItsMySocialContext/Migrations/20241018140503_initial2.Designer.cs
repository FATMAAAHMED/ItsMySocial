...
namespace ItsMySocialContext.Migrations
{
    ...
    [Migration("20241018140503_initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItsMySocialDomain.Entities.Comment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ItsMySocialDomain.Entities.Post", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ItsMySocialDomain.Entities.Share", b =>
                {
                    b.Property<long>("PostId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ItsMySocialDomain.Entities.Comment", b =>
                {
                    b.HasOne("ItsMySocialDomain.Entities.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("ItsMySocialDomain.Entities.User", b =>
                {
                    b.HasOne("ItsMySocialDomain.Entities.User", null)
                        .WithMany("Friends")
                        .HasForeignKey("UserId");
                });
